                        ...
                        trending && trending.slice(0,3).map(item => (
                            <SwiperSlide key={item.id}>
                                ...
                                >
                                    ...
                                    <div className="flex px-5 xl:px-0 justify-between relative max-w-[1024px] mx-auto pb-10">
                                        <div className="w-full md:w-5/6 text-white lg:pr-16 mt-40 md:mt-32 lg:mt-64 mx-auto">
                                        ...
                                        <div className="lg:mt-40 md:mt-32 mt-40 pl-5 lg:px-5 xl:px-0">
                                            <img className='w-64 lg:w-[300px] rounded-lg shadow-md' src={request.imgUrl + item.poster_path} alt="" />
                                        </div>
                                    </div>
                                </div>
                            </SwiperSlide>
